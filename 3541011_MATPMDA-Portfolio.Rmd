...
The mean number of steps on breafakst days is greater than the mean number of steps on non-breakfast days.
...
```{r}
observed <- c(BreakfastYesWEND=3, BrekfastYesWDAY=7)
expected <- c(BreakfastYesWEND=5, BreakfastYesWDAY=5)
